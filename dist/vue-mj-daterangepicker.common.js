...
function (_Vue) {
  ...
  _createClass(default_1, [{
    ...
    key: "changeFrom",
    value: function changeFrom(from) {
      if (this.from) {
    ...
    value: function affectPreset(preset) {
      ...
      switch (preset) {
        ...
        case 'last7days':
          this.values = {
            from: Object(date_fns["startOfDay"])(Object(date_fns["subDays"])(this.now, 7)),
            to: Object(date_fns["subDays"])(this.now, 1)
          };
          break;

        case 'next7days':
          this.values = {
            to: Object(date_fns["startOfDay"])(Object(date_fns["addDays"])(this.now, 7)),
            from: this.now
          };
          break;
        ...
        case 'last30days':
          this.values = {
            from: Object(date_fns["startOfDay"])(Object(date_fns["subDays"])(this.now, 30)),
            to: Object(date_fns["subDays"])(this.now, 1)
          };
          break;
        ...
        case 'next30days':
          this.values = {
            to: Object(date_fns["startOfDay"])(Object(date_fns["addDays"])(this.now, 30)),
            from: this.now
          };
          break;
        ...
        case 'last90days':
          this.values = {
            from: Object(date_fns["startOfDay"])(Object(date_fns["subDays"])(this.now, 90)),
            to: Object(date_fns["subDays"])(this.now, 1)
          };
          break;
        ...
        case 'next90days':
          this.values = {
            to: Object(date_fns["startOfDay"])(Object(date_fns["addDays"])(this.now, 90)),
            from: this.now
          };
          break;
        ...
        case 'last365days':
          this.values = {
            from: Object(date_fns["startOfDay"])(Object(date_fns["subDays"])(this.now, 365)),
            to: Object(date_fns["subDays"])(this.now, 1)
          };
          break;
        ...
        case 'next365days':
          this.values = {
            to: Object(date_fns["startOfDay"])(Object(date_fns["addDays"])(this.now, 365)),
            from: this.now
          };
          break;
        ...
        case 'pastMonth':
          this.values = {
            from: Object(date_fns["startOfMonth"])(Object(date_fns["subMonths"])(this.now, 1)),
            to: Object(date_fns["endOfMonth"])(Object(date_fns["subMonths"])(this.now, 1))
          };
          break;
        ...
        case 'nextMonth':
          this.values = {
            to: Object(date_fns["startOfMonth"])(Object(date_fns["addMonths"])(this.now, 1)),
            from: Object(date_fns["endOfMonth"])(Object(date_fns["addMonths"])(this.now, 1))
          };
          break;
      }
    }
    ...
    value: function created() {
      ...
      this.current = this.values.to !== null ? this.values.to : this.now; // Update Calendar
    ...
    value: function updateCalendar() {
      for (var i = 0; i < this.amountCalendars; i++) {
        var days = [];
        var lastDayOfMonth = Object(date_fns["endOfMonth"])(Object(date_fns["subMonths"])(this.current, i));
        var firstDayOfMonth = Object(date_fns["startOfMonth"])(Object(date_fns["subMonths"])(this.current, i));
        ...
        while (Object(date_fns["isBefore"])(day, lastDayOfMonth) || days.length % 7 > 0) {
          days.push({
            ...
            currentMonth: Object(date_fns["isSameMonth"])(Object(date_fns["subMonths"])(this.current, i), day)
          });
      ...
      this.monthDays = this.monthDays.reverse(); // console.log(this.current)
    }
  }, {
    key: "dayClasses",
    ...
    get: function get() {
      var week = [];
      var days = this.monthDays[0].slice(0, 7);
    ...
    key: "lastMonthName",
    get: function get() {
      return Object(date_fns["format"])(Object(date_fns["subMonths"])(this.current, 1), 'MMMM YYYY', {
        locale: locales[this.locale]
      });
    }
  }, {
...
__decorate([Prop({
  type: String,
  default: 'vertical'
})], DateRangePickervue_type_script_lang_ts_default_1.prototype, "orientation", void 0);

__decorate([Prop({
  type: Number,
  default: 1
})], DateRangePickervue_type_script_lang_ts_default_1.prototype, "amountCalendars", void 0);
...
__decorate([Watch('from')], DateRangePickervue_type_script_lang_ts_default_1.prototype, "changeFrom", null);

__decorate([Watch('to')], DateRangePickervue_type_script_lang_ts_default_1.prototype, "changeTo", null);
